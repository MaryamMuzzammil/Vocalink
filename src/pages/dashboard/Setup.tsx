...
const Setup: React.FC = () => {
  ...
  useEffect(() => {
    const savedData = localStorage.getItem('vocalink_business_setup');
    if (savedData) {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      localStorage.setItem('vocalink_business_setup', JSON.stringify(formData));
      setIsSaving(false);
      setShowSuccess(true);
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border-none rounded-xl py-3 px-4 text-sm font-bold text-slate-700 focus:ring-1 focus:ring-black/5"
                />
              </div>
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-slate-50 border-none rounded-xl py-3 px-4 text-sm font-bold text-slate-700 focus:ring-1 focus:ring-black/5 appearance-none"
                >
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border-none rounded-xl py-4 px-6 text-sm font-bold text-slate-700 focus:ring-1 focus:ring-black/5 resize-none"
                />
              </div>
              <div className="space-y-2">
