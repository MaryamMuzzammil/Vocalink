...
const Orders: React.FC = () => {
  const [orders, setOrders] = useState<Order[]>([
    { id: 'ORD-7241', customerName: 'Ahmed Khan', phone: '0300-1234567', items: 'Zinger Burger x1, Fries x2', notes: 'No mayo in burger', status: 'New', staff: '-', time: '2m ago' },
    { id: 'ORD-7240', customerName: 'Sarah Ali', phone: '0321-7654321', items: 'Large Pizza x1, Coke 1.5L', notes: 'Extra spicy', status: 'Confirmed', staff: 'Bilal', time: '15m ago' },
    { id: 'ORD-7239', customerName: 'M. Bilal', phone: '0333-9876543', items: 'Club Sandwich x3', notes: '-', status: 'Preparing', staff: 'Kashif', time: '28m ago' },
    { id: 'ORD-7238', customerName: 'Kashif R.', phone: '0345-1112223', items: 'Chicken Wings x2', notes: '-', status: 'Completed', staff: 'Bilal', time: '1h ago' },
    { id: 'ORD-7237', customerName: 'John D.', phone: '0312-3334445', items: 'Fish & Chips x1', notes: 'ASAP', status: 'Cancelled', staff: '-', time: '2h ago' },
  ]);
        ...
        <div className="p-6 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="relative flex-grow max-w-md">
            ...
            <input 
              ...
              className="w-full bg-slate-50 border-none rounded-xl py-2 pl-10 pr-4 text-sm font-medium focus:ring-1 focus:ring-black/5 transition-all"
            />
          </div>
          <div className="flex items-center gap-3">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <select 
                        ...
                        className="bg-slate-50 border border-slate-100 rounded-lg py-1 px-2 text-[10px] font-bold uppercase focus:outline-none focus:ring-1 focus:ring-black/5 appearance-none cursor-pointer hover:bg-slate-100 transition-all text-slate-500"
                      >
